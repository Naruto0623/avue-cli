...
<style>
  .main-box {
    background: -webkit-linear-gradient(-90deg, #3e73a5 0, #b0c4df 39%, #b0c4df 100%);
    background: -moz-linear-gradient(180deg, #3e73a5 0, #b0c4df 39%, #b0c4df 100%);
    background: linear-gradient(180deg, #3e73a5 0, #b0c4df 39%, #b0c4df 100%);
