      ...
      <el-aside :width="rightWidth" style="background-color: transparent;border-radius: 6px;">
            ...
            <el-collapse v-model="activeNames">
              ...
              <el-collapse-item name="2" title="一审公诉（刑检）受理信息">
                <avue-form ref="form0" v-model="form0"
                           ...
                           @submit="submit">
                  <!--<template slot-scope="scope" slot="name3">
                    <span>{{ scope.name3 }}</span>
                  </template>-->
                </avue-form>
              </el-collapse-item>
            </el-collapse>
        ...
        <el-card v-if="isNext" class="box-card">
          <div style="position: relative;">
            <el-button type="primary" style="position: absolute;top: 5px;right: 0;" size="small">提交</el-button>
            <el-tabs v-model="activeName" @tab-click="handleClick">
              <el-tab-pane label="案卡" name="1">
                <el-collapse v-model="activeNamesanka">
                  <el-collapse-item title="审查起诉案件信息" name="1">
                    <el-row>
                  ...
                  <el-collapse-item title="审判活动监督情况" name="2">
                    <el-row>
                      <el-radio v-model="radio" label="1">全选是</el-radio>
                      <el-radio v-model="radio" label="2">全选否</el-radio>
                    </el-row>
                  ...
                  <el-collapse-item title="犯罪嫌疑人/单位" name="3">
                    <el-row>
                      <el-radio v-model="radio" label="1">全选是</el-radio>
                      <el-radio v-model="radio" label="2">全选否</el-radio>
                    </el-row>
                  ...
                  <el-collapse-item title="被害人/单位" name="4">
                    <el-row>
                      <el-radio v-model="radio" label="1">全选是</el-radio>
                      <el-radio v-model="radio" label="2">全选否</el-radio>
                    </el-row>
